...
class PoliticsIndia extends React.Component {
    constructor() {
        super()
        this.state = {
            source : [ ]
    ...
    componentDidMount() {
        fetch('https://api.currentsapi.services/v1/latest-news?country=in&category=politics&apiKey=09tlLmAwWRqqBBmOTFRzaKhqkA4nhnIUiZ9bBiFLtHYNLkOJ')
