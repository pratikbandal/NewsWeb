    ...
    body = (
      <div className={classes.paper}>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['Business', 'Entertainment', 'General', 'Health', 'Science', 'Sports', 'Technology'].map((category, i) => <Chip key= {i}  label={category} color="primary" className={classes.chip} />)}</div>
        </div>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['Donald Trump', 'Bitcoin', 'PlayStation 5', 'Smartphones'].map((term, i) => <Chip key= {i} label={term} color="primary" className={classes.chip} />)}<Chip label="...and more" className={classes.chip} /></div>
        </div>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['CNN', 'Wired', 'BBC News', 'Time', 'IGN', 'Buzzfeed', 'ABC News'].map((source, i) => <Chip key= {i} label={source} color="primary" className={classes.chip} />)}<Chip label="...and more" className={classes.chip} /></div>
        </div>
